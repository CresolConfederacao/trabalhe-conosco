...
function dhtmlXContainer(j) {
    ...
    this.obj._init = function () {
        this.vs[this.av].dhxcont.innerHTML = "<div id='div" + this.getAttribute("tab_id") + "' style='position: relative; left: 0px; top: 0px; overflow: hidden;'></div><div ida='dhxContBlocker' class='dhxcont_content_blocker' style='display: none;'></div><div id='dvprocessando" + this.getAttribute("tab_id") + "' class='dvprocessando' style='display: none;'></div>";
    ...
    this.obj._setPadding = function (a, b) {
        typeof a == "object" ? (this._offsetTop = a[0], this._offsetLeft = a[1], this._offsetWidth = a[2], this._offsetHeight = a[3]) : (this._offsetLeft = this._offsetTop = a, this._offsetWidth = -a * 2, this._offsetHeight = -a * 2);
    ...
    this.obj.moveContentTo = function (a) {
        for (var b in this.vs) {
            ...
            c != null && (a.view(b).attachObject(this.vs[b][c + "Id"]), a.vs[b][c] = this.vs[b][c], a.vs[b][c + "Id"] = this.vs[b][c + "Id"], a.vs[b][c + "Obj"] = this.vs[b][c + "Obj"], this.vs[b][c] = null, this.vs[b][c + "Id"] = null, this.vs[b][c + "Obj"] = null);
            if (this.vs[b]._frame) a.vs[b]._frame = this.vs[b]._frame, this.vs[b]._frame = null;
            if (this.vs[b].menu != null) a.cv == a.av ? a.vs[a.av].dhxcont.insertBefore(document.getElementById(this.vs[b].menuId), a.vs[a.av].dhxcont.childNodes[0]) : a._getSt().appendChild(document.getElementById(this.vs[b].menuId)), a.vs[b].menu = this.vs[b].menu, a.vs[b].menuId = this.vs[b].menuId, a.vs[b].menuHeight = this.vs[b].menuHeight, this.vs[b].menu = null, this.vs[b].menuId = null, this.vs[b].menuHeight = null, this.cv == this.av && this._doOnAttachMenu && this._doOnAttachMenu("unload"), a.cv == a.av && a._doOnAttachMenu && a._doOnAttachMenu("move");
            if (this.vs[b].toolbar != null) a.cv == a.av ? a.vs[a.av].dhxcont.insertBefore(document.getElementById(this.vs[b].toolbarId), a.vs[a.av].dhxcont.childNodes[a.vs[a.av].menu != null ? 1 : 0]) : a._getSt().appendChild(document.getElementById(this.vs[b].toolbarId)), a.vs[b].toolbar = this.vs[b].toolbar, a.vs[b].toolbarId = this.vs[b].toolbarId, a.vs[b].toolbarHeight = this.vs[b].toolbarHeight, this.vs[b].toolbar = null, this.vs[b].toolbarId = null, this.vs[b].toolbarHeight = null, this.cv == this.av && this._doOnAttachToolbar && this._doOnAttachToolbar("unload"), a.cv == a.av && a._doOnAttachToolbar && a._doOnAttachToolbar("move");
            if (this.vs[b].sb != null) a.cv == a.av ? a.vs[a.av].dhxcont.insertBefore(document.getElementById(this.vs[b].sbId), a.vs[a.av].dhxcont.childNodes[a.vs[a.av].dhxcont.childNodes.length - 1]) : a._getSt().appendChild(document.getElementById(this.vs[b].sbId)), a.vs[b].sb = this.vs[b].sb, a.vs[b].sbId = this.vs[b].sbId, a.vs[b].sbHeight = this.vs[b].sbHeight, this.vs[b].sb = null, this.vs[b].sbId = null, this.vs[b].sbHeight = null, this.cv == this.av && this._doOnAttachStatusBar && this._doOnAttachStatusBar("unload"), a.cv == a.av && a._doOnAttachStatusBar && a._doOnAttachStatusBar("move");
            for (var d = this.vs[b].dhxcont.mainCont[b], f = a.vs[b].dhxcont.mainCont[b]; d.childNodes.length > 0;) f.appendChild(d.childNodes[0])
        }
        a.view(this.av).setActive()
    };
    this.obj.adjustContent = function (a, b, c, d, f) {
        this.vs[this.av].dhxcont.style.left = (this._offsetLeft || 0) + "px";
        this.vs[this.av].dhxcont.style.top = (this._offsetTop || 0) + b + "px";
        var e = a.clientWidth + (this._offsetWidth || 0);
        if (d !== !0) this.vs[this.av].dhxcont.style.width = Math.max(0, e) + "px";
        if (d !== !0 && this.vs[this.av].dhxcont.offsetWidth > e) this.vs[this.av].dhxcont.style.width = Math.max(0, e * 2 - this.vs[this.av].dhxcont.offsetWidth) + "px";
        var g = a.clientHeight + (this._offsetHeight || 0);
        this.vs[this.av].dhxcont.style.height = Math.max(0, g - b) + (c != null ? c : 0) + "px";
        if (this.vs[this.av].dhxcont.offsetHeight > g - b) this.vs[this.av].dhxcont.style.height = Math.max(0, (g - b) * 2 - this.vs[this.av].dhxcont.offsetHeight) + "px";
        if (f && !isNaN(f)) this.vs[this.av].dhxcont.style.height = Math.max(0, parseInt(this.vs[this.av].dhxcont.style.height) - f) + "px";
        if (this.vs[this.av]._minDataSizeH != null && parseInt(this.vs[this.av].dhxcont.style.height) < this.vs[this.av]._minDataSizeH) this.vs[this.av].dhxcont.style.height = this.vs[this.av]._minDataSizeH + "px";
        if (this.vs[this.av]._minDataSizeW != null && parseInt(this.vs[this.av].dhxcont.style.width) < this.vs[this.av]._minDataSizeW) this.vs[this.av].dhxcont.style.width = this.vs[this.av]._minDataSizeW + "px";
        if (d !== !0 && (this.vs[this.av].dhxcont.mainCont[this.av].style.width = this.vs[this.av].dhxcont.clientWidth + "px", this.vs[this.av].dhxcont.mainCont[this.av].offsetWidth > this.vs[this.av].dhxcont.clientWidth)) this.vs[this.av].dhxcont.mainCont[this.av].style.width = Math.max(0, this.vs[this.av].dhxcont.clientWidth * 2 - this.vs[this.av].dhxcont.mainCont[this.av].offsetWidth) + "px";
        var h = this.vs[this.av].menu != null ? !this.vs[this.av].menuHidden ? this.vs[this.av].menuHeight : 0 : 0,
            k = this.vs[this.av].toolbar != null ? !this.vs[this.av].toolbarHidden ? this.vs[this.av].toolbarHeight : 0 : 0,
            i = this.vs[this.av].sb != null ? !this.vs[this.av].sbHidden ? this.vs[this.av].sbHeight : 0 : 0;
        ...
        this.vs[this.av].dhxcont.mainCont[this.av].style.height = Math.max(0, parseInt(this.vs[this.av].dhxcont.mainCont[this.av].style.height) - h - k - i) + "px"
    };
    ...
    this.obj.attachStatusBar = function () {
        if (!this.vs[this.av].sb) {
            ...
            this.cv == this.av ? this.vs[this.av].dhxcont.insertBefore(a, this.vs[this.av].dhxcont.childNodes[this.vs[this.av].dhxcont.childNodes.length - 1]) : e.st.appendChild(a);
    ...
    this.obj.detachStatusBar = function () {
        if (this.vs[this.av].sb) this.vs[this.av].sb.setText = null, this.vs[this.av].sb.getText = null, this.vs[this.av].sb.onselectstart = null, this.vs[this.av].sb.parentNode.removeChild(this.vs[this.av].sb), this.vs[this.av].sb = null, this.vs[this.av].sbHeight = null, this.vs[this.av].sbId = null, this._viewRestore(), this._doOnAttachStatusBar && this._doOnAttachStatusBar("unload")
    };
    ...
    this.obj.attachMenu = function (a) {
        if (!this.vs[this.av].menu) {
            ...
            this.cv == this.av ? this.vs[this.av].dhxcont.insertBefore(b, this.vs[this.av].dhxcont.childNodes[0]) : e.st.appendChild(b);
    ...
    this.obj.attachToolbar = function (a) {
        if (!this.vs[this.av].toolbar) {
            ...
            b.style.position = "relative";
            b.style.overflow = "hidden";
            b.id = "dhxtoolbar_" + this._genStr(12);
            this.cv == this.av ? this.vs[this.av].dhxcont.insertBefore(b, this.vs[this.av].dhxcont.childNodes[this.vs[this.av].menu != null ? 1 : 0]) : e.st.appendChild(b);
            ...
            this.vs[this.av].toolbarHeight = this.skin == "dhx_web" ? 41 : b.offsetHeight + (this._isLayout && this.skin == "dhx_skyblue" ? 2 : 0);
    ...
    this.obj.attachTabbar = function (a) {
        ...
        document.body.appendChild(b);
        this.attachObject(b.id, !1, !0);
        this.className == "dhtmlxLayoutSinglePoly" && this.hideHeader();
        this.vs[this.av].tabbar = new dhtmlXTabBar(b.id, a || "top", 20);
        if (!this._isWindow) this.vs[this.av].tabbar._s.expand = !0;
    ...
    this.obj.attachEditor = function () {
        if (this._isWindow && this.skin == "dhx_skyblue") this.vs[this.av].dhxcont.mainCont[this.av].style.border = "#a4bed4 1px solid", this._redraw();
        var a = document.createElement("DIV");
        ...
        document.body.appendChild(a);
        this.attachObject(a.id, !1, !0);
        this.vs[this.av].editor = new dhtmlXEditor(a.id, this.skin);
    ...
    this.obj.attachObject = function (a, b, c) {
        ...
        if (b && this._isWindow) a.style.visibility = "", this._adjustToContent(d, f);
        c || this._viewRestore()
    };
    this.obj.detachObject = function (a, b) {
        for (var c = null, d = null, f = "tree,grid,layout,tabbar,accordion,folders".split(","), e = 0; e < f.length; e++) if (this.vs[this.av][f[e]]) {
            c = this.vs[this.av][f[e]];
            d = this.vs[this.av][f[e] + "Obj"];
            if (a) {
                c.unload && c.unload();
            ...
            this.vs[this.av][f[e]] = null;
            this.vs[this.av][f[e] + "Id"] = null;
            this.vs[this.av][f[e] + "Obj"] = null
        }
        ...
        for (var g = this.vs[this.av].dhxcont.mainCont[this.av]; g.childNodes.length > 0;) if (a == !0) g.removeChild(g.childNodes[0]);
            ...
            b != null ? (typeof b != "object" && (b = document.getElementById(b)), b.appendChild(h)) : document.body.appendChild(h);
    ...
    this.obj.attachHTMLString = function (a) {
        ...
        for (var b = a.match(/<script[^>]*>[^\f]*?<\/script>/g) || [], c = 0; c < b.length; c++) {
            ...
            window.execScript ? window.execScript(d) : window.eval(d)
        }
    };
    ...
    this.obj.adjust = function () {
        if (this.skin == "dhx_skyblue") {
            ...
            if (this.vs[this.av].toolbar) {
                if (this._isWindow || this._isLayout) document.getElementById(this.vs[this.av].toolbarId).style.height = "29px", this.vs[this.av].toolbarHeight = document.getElementById(this.vs[this.av].toolbarId).offsetHeight, this._doOnAttachToolbar && this._doOnAttachToolbar("show");
    ...
    this.obj._attachContent = function (a, b, c) {
        ...
        if (a == "url") {
            ...
            d.id = "iframe" + this.getAttribute("tab_id");
            d.name = "iframe" + this.getAttribute("tab_id");
            d.frameBorder = 0;
            d.border = 0;
            d.style.width = "100%";
            d.style.height = "100%";
    ...
    this.obj.showToolbar = function () {
        if (this.vs[this.av].toolbar && this.vs[this.av].toolbarId && document.getElementById(this.vs[this.av].toolbarId).style.display == "none") this.vs[this.av].toolbarHidden = !1, this._doOnAttachToolbar && this._doOnAttachToolbar("show"), document.getElementById(this.vs[this.av].toolbarId).style.display = "", this._viewRestore()
    };
    this.obj.hideToolbar = function () {
        if (this.vs[this.av].toolbar && this.vs[this.av].toolbarId && document.getElementById(this.vs[this.av].toolbarId).style.display != "none") this.vs[this.av].toolbarHidden = !0, document.getElementById(this.vs[this.av].toolbarId).style.display = "none", this._doOnAttachToolbar && this._doOnAttachToolbar("hide"), this._viewRestore()
    };
    ...
    this.obj.hideStatusBar = function () {
        if (this.vs[this.av].sb && this.vs[this.av].sbId && document.getElementById(this.vs[this.av].sbId).style.display != "none") this.vs[this.av].sbHidden = !0, document.getElementById(this.vs[this.av].sbId).style.display = "none", this._doOnAttachStatusBar && this._doOnAttachStatusBar("hide"), this._viewRestore()
    };
    this.obj._dhxContDestruct = function () {
        var a = this.av,
            b;
        for (b in this.vs) this.av = b, this.detachMenu(), this.detachToolbar(), this.detachStatusBar(), this.detachObject(!0), this.vs[b].dhxcont.mainCont[b].parentNode.removeChild(this.vs[b].dhxcont.mainCont[b]), this.vs[b].dhxcont.mainCont[b] = null;
        this.vs[this.dv].dhxcont.mainCont = null;
        this.vs[this.dv].dhxcont.parentNode.removeChild(this.vs[this.dv].dhxcont);
        for (b in this.vs) this.vs[b].dhxcont = null;
        ...
        e.st.parentNode.removeChild(e.st);
        e.st = null;
        e.setContent = null;
        e.dhxcont = null;
        e = e.obj = null;
    ...
    if (dhtmlx.attaches) for (var i in dhtmlx.attaches) this.obj[i] = dhtmlx.attaches[i]
};
